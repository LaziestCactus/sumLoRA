...
def objective(trial):
    ...
    trial_model_path = f"{save_dir}/model_trial_{trial.number}"
    trainer.save_model(trial_model_path)
...
best_trial_path = f"{save_dir}/best_trial.json"
with open(best_trial_path, "w") as f:
    json.dump({"best_hyperparameters": study.best_trial.params, "best_loss": study.best_value}, f, indent=4)

print("Best hyperparameters:", study.best_trial.params)
print("Best validation loss:", study.best_value)
print(f"Best model and tokenizer saved at: {save_dir}/model_trial_{study.best_trial.number}")
print(f"Best trial info saved at: {best_trial_path}")
